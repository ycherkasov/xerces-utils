...
if(EXISTS "${OpenCV_DIR}")
        ...
        #Otherwise it try to guess it.
                ...
                set(OpenCV_INCLUDE_DIRS ${OpenCV_INCLUDE_DIR} "${OpenCV_DIR}/include")
        ...
        #add OpenCV 3rdparty libs
        if(OpenCV_FOUND_TMP)
        	set(OpenCV_3rdparty_DIR ${OpenCV_DIR}/3rdparty)
	        foreach(_3rd_LIB flann;zlib;opencv_lapack;libjasper;libjpeg;libpng;libtiff)
        		find_library(OpenCV_3rd_${_3rd_LIB}_LIB NAMES ${_3rd_LIB} PATHS "${OpenCV_3rdparty_DIR}/lib" NO_DEFAULT_PATH)
			SET(OpenCV_LIBS	${OpenCV_3rd_${_3rd_LIB}_LIB} ${OpenCV_LIBS})
		endforeach(_3rd_LIB)

		if(MSVC)
	        	set(OpenCV_3rdparty_MicrosoftSDK_LIB_DIR "C:/Program Files/Microsoft SDKs/Windows/v6.0A/Lib" CACHE PATH "Microsoft SDK lib dir for Vfw32.lib")
		        foreach(_3rd_LIB Vfw32;ComCtl32)
	        		find_library(OpenCV_3rd_${_3rd_LIB}_LIB NAMES ${_3rd_LIB} PATHS "${OpenCV_3rdparty_MicrosoftSDK_LIB_DIR}" NO_DEFAULT_PATH)
				SET(OpenCV_LIBS	${OpenCV_3rd_${_3rd_LIB}_LIB} ${OpenCV_LIBS})
			endforeach(_3rd_LIB)
		endif(MSVC)
	endif(OpenCV_FOUND_TMP)
